...
-- 
-- Host: localhost
-- Generato il: 11 Apr, 2008 at 08:09 PM
...
CREATE TABLE `city` (
  ...
  `Name` char(35) NOT NULL COMMENT 'Nome della città',
  `CountryCode` char(3) NOT NULL COMMENT 'Chiave esterna che fa riferimento al codice nella tabella country',
  `District` char(20) NOT NULL COMMENT 'Corrisponde a quello che in Italia sono le regioni',
  `Population` int(11) NOT NULL default '0' COMMENT 'Popolazione della città',
  PRIMARY KEY  (`ID`)
...
CREATE TABLE `country` (
  ...
  `Name` char(52) NOT NULL COMMENT 'Nome della nazione',
  `Continent` enum('Asia','Europe','North America','Africa','Oceania','Antarctica','South America') NOT NULL default 'Asia' COMMENT 'Continente in cui si trova la nazione',
  `Region` char(26) NOT NULL COMMENT 'Regione all''interno di un continente, ad esempio Europa orientale',
  `SurfaceArea` float(10,2) NOT NULL default '0.00' COMMENT 'Superficie',
  `IndepYear` smallint(6) default NULL COMMENT 'Anno di nascita della nazione, ad esempio per l''Italia 1861',
  `Population` int(11) NOT NULL default '0' COMMENT 'Numero di abitanti',
  `LifeExpectancy` float(3,1) default NULL COMMENT 'Aspettativa di vita',
  `GNP` float(10,2) default NULL COMMENT 'Prodotto interno lordo in milioni di dollari',
  `GNPOld` float(10,2) default NULL COMMENT 'Prodotto interno lordo dell''anno precedente',
  `LocalName` char(45) NOT NULL COMMENT 'Nome della nazione nella lingua locale',
  `GovernmentForm` char(45) NOT NULL COMMENT 'Forma di governo',
  `HeadOfState` char(60) default NULL COMMENT 'Nome del capo di stato',
  `Capital` int(11) default NULL COMMENT 'Chiave esterna che fa riferimento all''ID della città nella tabella country',
  `Code2` char(2) NOT NULL COMMENT 'Altro codice della nazione',
  PRIMARY KEY  (`Code`)
...
-- 
-- Struttura della tabella `countrylanguage`
-- 

CREATE TABLE `countrylanguage` (
  `CountryCode` char(3) NOT NULL COMMENT 'Chiave esterna che fa riferimento al codice in country',
  `Language` char(30) NOT NULL COMMENT 'Uno dei linguaggi in uso',
  `IsOfficial` enum('T','F') NOT NULL default 'F' COMMENT 'Booleano che dice se il linguaggio è ufficiale (T) o no (F)',
  `Percentage` float(4,1) NOT NULL default '0.0' COMMENT 'Percentuale della popolazione che parla questo linguaggio',
  PRIMARY KEY  (`CountryCode`,`Language`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- 
-- Dump dei dati per la tabella `countrylanguage`
-- 
